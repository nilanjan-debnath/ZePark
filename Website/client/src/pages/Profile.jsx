                ...
                <div className='w-full bg-[#F8EDE3]'>
                    ...
                    <div className="h-[90%] w-full flex items-center flex-col gap-2 py-4">
                        <div className="relative">
                            ...
                            <button onClick={(e) => fileRef.current.click()} className="absolute bottom-[10%] left-[75%] text-white bg-[#C5705D] p-2 rounded-full"><FaPencilAlt className='text-lg' /></button>
                        </div>
                        ...
                        <div className="btmBox flex flex-col justify-center items-center gap-4 w-[22rem] p-4 sm:w-[26rem]">
                            ...
                            <Link to='/booking-history' className="w-full pl-8 pr-4 py-3 flex items-center justify-between rounded-full bg-[#DFD3C3]">
